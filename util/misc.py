...
def load_model(args, model_without_ddp, optimizer=None, loss_scaler=None):
    if args.resume:
        ...
        message = model_without_ddp.load_state_dict(new_checkpoint, strict=False)
        print(message)
        ...
        if loss_scaler is not None and 'scaler' in checkpoint:
            message = loss_scaler.load_state_dict(checkpoint['scaler'])
            print(message)
        print("Resume checkpoint %s" % args.resume)
        return start_epoch, model_without_ddp, optimizer, loss_scaler
